        ...
        <div class="col-md-9">
            ...
            <div class="card shadow border-0 rounded-4">
                <div class="card-body p-4 p-md-5">
                    ...
                    {{-- 3. FORMULARUL --}}
                    <form action="{{ route('project-cost-items.store', $project) }}" method="POST">
                        @csrf
                        
                        <p class="text-muted mb-4 fst-italic">
                            <i class="bi bi-info-circle me-1"></i>
                            Introduceți costurile manuale. Sumele vor fi adunate la totalul costurilor materiale actuale.
                        </p>
                        ...
                        <div class="form-section mb-4">
                            ...
                            <p class="text-muted small mb-3">Definiți categoria și descrierea costului.</p>
                            <hr class="mt-0 mb-4 opacity-50">

                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="category" class="form-label fw-semibold">Categorie</label>
                                    <input type="text" name="category" id="category" value="{{ old('category') }}" class="form-control" placeholder="Ex: Robot, Safety, Logistics">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="line_item" class="form-label fw-semibold">Articol (Line item)</label>
                                    <input type="text" name="line_item" id="line_item" value="{{ old('line_item') }}" class="form-control" placeholder="Ex: Senzor laser Sick">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-section mb-4">
                            ...
                            <p class="text-muted small mb-3">Completați cel puțin unul dintre câmpurile financiare.</p>
                            <hr class="mt-0 mb-4 opacity-50">

                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="planned_budget" class="form-label fw-semibold">Planned Budget</label>
                                    <input type="number" step="0.01" min="0" name="planned_budget" id="planned_budget" value="{{ old('planned_budget') }}" class="form-control" placeholder="0.00">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="committed_po" class="form-label fw-semibold">Committed PO</label>
                                    <input type="number" step="0.01" min="0" name="committed_po" id="committed_po" value="{{ old('committed_po') }}" class="form-control" placeholder="0.00">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="actual_cost" class="form-label fw-semibold">Actual Cost</label>
                                    <input type="number" step="0.01" min="0" name="actual_cost" id="actual_cost" value="{{ old('actual_cost') }}" class="form-control" placeholder="0.00">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="forecast_to_complete" class="form-label fw-semibold">Forecast to complete</label>
                                    <input type="number" step="0.01" min="0" name="forecast_to_complete" id="forecast_to_complete" value="{{ old('forecast_to_complete') }}" class="form-control" placeholder="0.00">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex gap-3">
                            <button type="submit" class="btn btn-primary btn-lg rounded-pill px-4">
                                <i class="bi bi-save me-1"></i> Salvează Cost
                            </button>
