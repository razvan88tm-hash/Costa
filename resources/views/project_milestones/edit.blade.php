            ...
            <div class="card shadow border-0 rounded-4">
                <div class="card-body p-4 p-md-5">
                    ...
                    <p class="text-muted mb-4">
                        Modifici: <strong>{{ $milestone->name }}</strong>
                        <br>
                    ...
                    {{-- 3. FORMULARUL --}}
                    <form action="{{ route('project-milestones.update', [$project, $milestone]) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-section mb-4">
                            ...
                            <p class="text-muted small mb-3">Modificați tipul și denumirea milestone-ului.</p>
                            <hr class="mt-0 mb-4 opacity-50">

                            <div class="mb-3">
                                <label for="type" class="form-label fw-semibold">Tip milestone *</label>
                                <select name="type" id="type" class="form-select" required>
                                    <option value="pm" {{ old('type', $milestone->type) == 'pm' ? 'selected' : '' }}>PM milestone (Managerial)</option>
                                    <option value="installation" {{ old('type', $milestone->type) == 'installation' ? 'selected' : '' }}>Installation milestone (Site)</option>
                                </select>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="description" id="description" class="form-control" rows="2">{{ old('description', $milestone->description) }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-section mb-4">
                            ...
                            <p class="text-muted small mb-3">Ajustați datele și starea curentă.</p>
                            <hr class="mt-0 mb-4 opacity-50">
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="date" name="planned_date" id="planned_date" class="form-control"
                                           value="{{ old('planned_date', $milestone->planned_date) }}">
                                </div>
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="date" name="actual_date" id="actual_date" class="form-control"
                                           value="{{ old('actual_date', $milestone->actual_date) }}">
                                </div>
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select name="status" id="status" class="form-select" required>
                                        ...
                                        <option value="done" {{ old('status', $milestone->status) == 'done' ? 'selected' : '' }}>Done</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-section mb-4">
                            ...
                            <input type="number" name="sort_order" id="sort_order" class="form-control" min="0"
                                   value="{{ old('sort_order', $milestone->sort_order) }}" style="max-width: 120px;">
                        ...
                        <div class="d-flex gap-3">
                            <button type="submit" class="btn btn-primary btn-lg rounded-pill px-4">
                                <i class="bi bi-arrow-up-circle me-1"></i> Actualizează
                            </button>
