<!-- resources/views/project-worker-logs/edit.blade.php -->
@extends('layouts.app')

@section('content')
<div class="container">
    <h1>Editează cost muncitor pentru proiectul: {{ $project->name ?? ('#'.$project->id) }}</h1>
    ...
    <form method="POST" action="{{ route('project-worker-logs.update', [$project, $workerLog]) }}">
        @csrf
        @method('PUT')
