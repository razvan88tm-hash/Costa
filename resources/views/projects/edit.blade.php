            ...
            <div class="card shadow border-0 rounded-4">
                <div class="card-body p-4 p-md-5">
                    ...
                    <p class="text-muted mb-4">
                        Modificați detaliile pentru: <strong>{{ $project->name }}</strong>
                    </p>
                    ...
                    <form action="{{ route('projects.update', $project) }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input
                                        ...
                                        id="customer_site"
                                        class="form-control"
                                        value="{{ old('customer_site', $project->customer_site) }}"
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="overall_rag" id="overall_rag" class="form-select" required>
                                        {{-- Adăugăm descrierile și pentru formularul de editare --}}
                                        <option value="Red" {{ old('overall_rag', $project->overall_rag) == 'Red' ? 'selected' : '' }}>Red (Problematic)</option>
                                        <option value="Orange" {{ old('overall_rag', $project->overall_rag) == 'Orange' ? 'selected' : '' }}>Orange (Atenție)</option>
                                        <option value="Green" {{ old('overall_rag', $project->overall_rag) == 'Green' ? 'selected' : '' }}>Green (OK)</option>
                                    </select>
                                </div>
                                <div class="col-md-6 mb-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input
                                        ...
                                        id="target_handover"
                                        class="form-control"
                                        value="{{ old('target_handover', $project->target_handover) }}"
                                    >
                                </div>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input
                                        ...
                                        id="real_handover"
                                        class="form-control"
                                        value="{{ old('real_handover', $project->real_handover) }}"
                                    >
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-section mb-5">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input
                                        ...
                                        id="sell_price"
                                        class="form-control"
                                        value="{{ old('sell_price', $project->sell_price) }}"
                                        step="0.01"
                                        min="0"
                                        placeholder="0.00"
                                    >
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input
                                        ...
                                        id="planned_budget"
                                        class="form-control"
                                        value="{{ old('planned_budget', $project->planned_budget) }}"
                                        step="0.01"
                                        min="0"
                                        placeholder="0.00"
                                    >
                            ...
                            <div class="mb-3">
                                ...
                                <input
                                    ...
                                    id="drive_folder_url"
                                    class="form-control"
                                    value="{{ old('drive_folder_url', $project->drive_folder_url) }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input
                                    ...
                                    id="layout_file_url"
                                    class="form-control"
                                    value="{{ old('layout_file_url', $project->layout_file_url) }}"
                                    placeholder="https://drive.google.com/..."
                                >
                            </div>
                        </div>
                        ...
                        <div class="d-flex gap-3">
                            <button type="submit" class="btn btn-primary btn-lg rounded-pill px-4">
                                <i class="bi bi-check-lg me-1"></i> Actualizează Proiect
                            </button>
